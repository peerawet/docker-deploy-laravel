<div>
    <div class="text-right mb-5">
        ...
        <livewire:components.assets.button color="pending" title="Incident Report" icon="file-text"
            route="drafts.report.accident" action="" />
    </div>
    <ul class="nav nav-tabs" id="Sell" role="tablist">
        <!-- Tab for "By Sea" -->
        <li class="nav-item mt-5" role="presentation">
            <button class="nav-link active" id="Sea-tab" data-bs-toggle="tab" data-bs-target="#Sea" type="button"
                role="tab" aria-controls="Sea" aria-selected="true"
                onclick="updateUrlParameter('tab', 'Sea')">Sea</button>
        </li>
        <!-- Tab for "By Truck" -->
        <li class="nav-item" role="presentation">
            <button class="nav-link mt-5" id="Truck-tab" data-bs-toggle="tab" data-bs-target="#Sea" type="button"
                role="tab" aria-controls="Truck" aria-selected="false"
                onclick="updateUrlParameter('tab', 'Truck')">Truck</button>
        </li>
        <!-- Tab for "By Air" -->
        <li class="nav-item" role="presentation">
            <button class="nav-link mt-5" id="Air-tab" data-bs-toggle="tab" data-bs-target="#Sea" type="button"
                role="tab" aria-controls="Air" aria-selected="false"
                onclick="updateUrlParameter('tab', 'Air')">Air</button>
        </li>
    </ul>
    ...
    <div class="intro-y box p-5">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="Sea" role="tabpanel" aria-labelledby="Sea-tab">
                <form action="{{ route('drafts.post') }}" method="POST">
                    @csrf
                            ...
                            <div class="intro-y box p-5">
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6 mt-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div id="booking_no_dropdown" class="custom-dropdown-booking"
                                            style="display: none;">
                                        </div>
                                    ...
                                    <script>
                                        jQuery(document).ready(function() {
                                            ...
                                            jQuery('#booking_no_input').on('input', function() {
                                                ...
                                                dropdown.toggle(filteredBookingNumbers.length > 0 || input !== '');
                                            });
                                ...
                                <div class = "intro-y col-span-12 lg:col-span-6 mt-5">
                                    ...
                                    <div class = "input-group">
                                        ...
                                        <button type = "button" id = "checkCustomerRefBtn" class = "btn btn-primary">
                                            Check
                                            Existence </button>
                                    </div>
                                    <div id = "customerRefResponse" class = "text-muted mt-5">
                                    </div>
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="dropdown">
                                        ...
                                        <input type="text" id="shipper_input" name="shipper_name"
                                            class="form-control" placeholder="Type to search shipper" autocomplete="off"
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="dropdown">
                                        ...
                                        <input type="text" id="agent_input" name="agent_name"
                                            class="form-control" placeholder="Type to search agent"
                                            autocomplete="off" value="{{ $draft->agent->name ?? '' }}">
                                    ...
                                    <div class="grid grid-cols-12 gap-4">
                                        <div class="col-span-12 lg:col-span-4">
                                            ...
                                            <input id="qty" name="qty" type="text"
                                                class="form-control w-full" placeholder="Volume"
                                                value="{{ $draft->qty ?? '' }}">
                                        </div>
                                        <div class="col-span-12 lg:col-span-4">
                                            <label for="container_type_input" class="form-label">Container
                                                Type</label>
                                            <input type="text" id="container_type_input"
                                                name="container_type_name" class="form-control"
                                                placeholder="Type to search container type" autocomplete="off"
                                                value="{{ $draft->containerType->size ?? '' }}">
                                            ...
                                            <div id="container_type_dropdown" class="custom-dropdown"
                                                style="display: none;">
                                            </div>
                                        </div>
                                        <div class="col-span-12 lg:col-span-4">
                                            ...
                                            <input id="temp" name="temp" type="text"
                                                class="form-control w-full" placeholder="Temp"
                                                value="{{ $draft->temp ?? '' }}">
                                        </div>
                                    </div>
                                    <script>
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="dropdown">
                                        <label for="destination_port_input" class="form-label">Port of
                                            Destination</label>
                                        <input type="text" id="destination_port_input"
                                            name="destination_port_name" class="form-control"
                                            placeholder="Type to search port" autocomplete="off"
                                        ...
                                        <div id="destination_port_dropdown" class="custom-dropdown"
                                            style="display: none;">
                                        </div>
                                    </div>
                                ...
                                <div id="transhipment-port-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="dropdown">
                                        <label for="transhipment_port_input" class="form-label">Transhipment
                                            Port</label>
                                        <input type="text" id="transhipment_port_input"
                                            name="transhipment_port_name" class="form-control"
                                            placeholder="Type to search port" autocomplete="off"
                                        ...
                                        <div id="transhipment_port_dropdown" class="custom-dropdown"
                                            style="display: none;">
                                        </div>
                                    </div>
                                ...
                                <div id="loading-port-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="dropdown">
                                        ...
                                        <div id="loading_port_dropdown" class="custom-dropdown"
                                            style="display: none;">
                                        </div>
                                    </div>
                                ...
                                <div id="pick-up-first-container-section"
                                    class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="flex justify-between items-center gap-5">
                                        <div class="intro-y col-span-3 lg:col-span-3">
                                            ...
                                            <input id="pick_up_date" name="pick_up_date" type="date"
                                                ...
                                                value="{{ $draft && $draft->pick_up_date ? \Carbon\Carbon::parse($draft->pick_up_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                        </div>
                                        ...
                                        <div class="intro-y col-span-3 lg:col-span-3">
                                            ...
                                            <input id="first_container_return_date" name="first_container_return_date"
                                                ...
                                                value="{{ $draft ? ($draft->first_container_return_date ? \Carbon\Carbon::parse($draft->first_container_return_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d')) : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                    ...
                                    <div class="flex justify-between items-center gap-5">
                                        <div class="intro-y col-span-12 lg:col-span-6">
                                            ...
                                            <input id="loading_date" name="loading_date" type="date"
                                                class="form-control w-full"
                                                value="{{ $draft && $draft->loading_date ? \Carbon\Carbon::parse($draft->loading_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                        </div>


                                        <div class="intro-y col-span-12 lg:col-span-6">
                                            <label for="loading_time" class="form-label">Loading Time</label>
                                            <input id="loading_time" name="loading_time" type="text"
                                ...
                                <div id="return-date-section" class="intro-y col-span-3 lg:col-span-3 mt-5">
                                    ...
                                    <input id="return_date" name="return_date" type="date"
                                        class="form-control w-full"
                                        value="{{ $draft && $draft->return_date ? \Carbon\Carbon::parse($draft->return_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                </div>
                                    ...
                                    <div class="flex justify-between items-center gap-5">
                                        ...
                                        <div class="intro-y col-span-12 lg:col-span-6">
                                            <div class="dropdown">
                                                ...
                                                <div id="feeder_dropdown" class="custom-dropdown"
                                                    style="display: none;">
                                                </div>
                                            </div>
                                        ...
                                        <div class="intro-y col-span-12 lg:col-span-6">
                                            ...
                                            <input id="voy_feeder" name="voy_feeder" type="text"
                                                class="form-control" placeholder="Voy"
                                                value="{{ $draft->voy_feeder ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex justify-between items-center gap-5">
                                        ...
                                        <div class="intro-y col-span-12 lg:col-span-6">
                                            <div class="dropdown">
                                                ...
                                                <div id="vessel_dropdown" class="custom-dropdown"
                                                    style="display: none;">
                                                </div>
                                            </div>
                                        ...
                                        <div class="intro-y col-span-12 lg:col-span-6">
                                            ...
                                            <input id="voy_vessel" type="text" class="form-control"
                                                placeholder="Voy" name="voy_vessel"
                                                value="{{ $draft->voy_vessel ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="flex justify-between items-center gap-5">
                                        ...
                                        <div id="ETD-section" class="intro-y col-span-2 lg:col-span-2">
                                            ...
                                            <input id="ETD_date" name="ETD_date" type="date"
                                                class="form-control w-full" placeholder="ETD Date"
                                                value="{{ $draft && $draft->ETD_date ? \Carbon\Carbon::parse($draft->ETD_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                        ...
                                        <div class="intro-y col-span-3 lg:col-span-3">
                                            ...
                                            <input id="ETA_date" type="date" class="form-control w-full"
                                                name="ETA_date" placeholder="ETA Date"
                                                value="{{ $draft && $draft->ETA_date ? \Carbon\Carbon::parse($draft->ETA_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                    ...
                                    <div class="flex justify-between items-center gap-5">
                                        <div class="intro-y col-span-3 lg:col-span-3">
                                            ...
                                            <input id="closing_date" type="date" class="form-control"
                                                ...
                                                value="{{ $draft && $draft->closing_date ? \Carbon\Carbon::parse($draft->closing_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">

                                        </div>
                                        <div class="intro-y col-span-2 lg:col-span-2">
                                            <label for="closing_time" class="form-label">Closing Time</label>
                                            <input id="closing_time" type="time" class="form-control"
                                                placeholder="Closing Time" name="closing_time"
                                ...
                                <div id="depot-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="dropdown">
                                        ...
                                        <input type="text" id="depot_input" name="depot_name"
                                            class="form-control" placeholder="Type to search depot"
                                            autocomplete="off" value="{{ $draft->depot->name ?? '' }}">
                                ...
                                <div id="gate-in-depot-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="dropdown">
                                        ...
                                        <div id="gate_in_depot_dropdown" class="custom-dropdown"
                                            style="display: none;">
                                        </div>
                                    </div>
                                ...
                                <div id="VGM-cut-off-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="flex justify-between items-center gap-5">
                                        <div class="intro-y col-span-2 lg:col-span-2">
                                            ...
                                            <input id="VGM_date" type="date" class="form-control w-full"
                                                name="VGM_date"
                                                value="{{ $draft && $draft->VGM_date ? \Carbon\Carbon::parse($draft->VGM_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">


                                        </div>
                                        <div class="intro-y col-span-3 lg:col-span-3">
                                            <label for="VGM_time" class="form-label">VGM Cut-Off time</label>
                                            <input id="VGM_time" type="time" class="form-control w-full"
                                                name="VGM_time" placeholder="VGM Cut-Off time"
                                ...
                                <div id="SI-cut-off-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    <div class="flex justify-between items-center gap-5">
                                        <div class="intro-y col-span-2 lg:col-span-2">
                                            ...
                                            <input id="SI_date" type="date" class="form-control w-full"
                                                name="SI_date"
                                                value="{{ $draft && $draft->SI_date ? \Carbon\Carbon::parse($draft->SI_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">


                                        </div>
                                        <div class="intro-y col-span-3 lg:col-span-3">
                                            <label for="SI_time" class="form-label">SI Cut-Off time</label>
                                            <input id="SI_time" type="time" class="form-control w-full"
                                                name="SI_time" placeholder="SI Cut-Off time"
                                ...
                                <div id="loading-location-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    ...
                                    <input type="text" id="loading_location_input" class="form-control"
                                        ...
                                        value="{{ $draft->loadingLocation->name ?? '' }}">
                                    ...
                                    <div id="loading_location_dropdown" class="custom-dropdown"
                                        style="display: none;">
                                    </div>
                                    <script>
                                        jQuery(document).ready(function() {
                                ...
                                <div id="cross-border-date-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    ...
                                    <div class="intro-y col-span-2 lg:col-span-2">
                                        ...
                                        <input id="cross_border_date" type="date" class="form-control w-full"
                                            ...
                                            value="{{ $draft && $draft->cross_border_date ? \Carbon\Carbon::parse($draft->cross_border_date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                    </div>
                                </div>
                                ...
                                <div id="delivery-location-section" class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    ...
                                    <input type="text" id="delivery_location_input" class="form-control"
                                        ...
                                        value="{{ $draft->deliveryLocation->name ?? '' }}"
                                    ...
                                    <div id="delivery_location_dropdown" class="custom-dropdown"
                                        style="display: none;">
                                    </div>
                                    <script>
                                        jQuery(document).ready(function() {
                            ...
                            <div class="intro-y box p-5">
                                ...
                                <div class="mt-5">
                                    ...
                                    <select class="form-select" name="status" id="status">
                                        ...
                                        <option value="Prepare"
                                            {{ $draft && $draft->status == 'Prepare' ? 'selected' : '' }}>
                                            Prepare</option>
                                        <option value="Get"
                                            {{ $draft && $draft->status == 'Get' ? 'selected' : '' }}>
                                            Get
                                        </option>
                                        <option value="Cancel"
                                            {{ $draft && $draft->status == 'Cancel' ? 'selected' : '' }}>
                                            Cancel</option>
                                    </select>
                                </div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <select class="form-select" name="type" id="type">
                                        ...
                                        <option value="Sea"
                                            {{ $draft && $draft->type == 'Sea' ? 'selected' : '' }}>
                                            By Sea</option>
                                        <option value="Truck"
                                            {{ $draft && $draft->type == 'Truck' ? 'selected' : '' }}>
                                            By Truck
                                        </option>
                                        <option value="Air"
                                            {{ $draft && $draft->type == 'Air' ? 'selected' : '' }}>
                                            By Air</option>
                                    </select>
                                </div>
                            ...
                            <div class="intro-y box p-5 mt-5">
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    ...
                                    <input id="draft_no" name="draft_no" type="text" class="form-control w-full"
                                        placeholder="Draft No." value="" disabled>
                                </div>

                                <div class="intro-y col-span-12 lg:col-span-6 mt-5">

                                    <label for="draft_date" class="form-label">Draft Date</label>
                                    <input id="draft_date" name="draft_date" type="datetime-local"
                                        class="form-control w-full" placeholder="Draft Date"
                                        value="{{ \Carbon\Carbon::now()->setTimezone('Asia/Bangkok')->format('Y-m-d\TH:i') }}"
                                ...
                                <div class="intro-y col-span-12 lg:col-span-6 mt-5">
                                    ...
                                    <input id="prepared_by" name="prepared_by" type="text"
                                        class="form-control w-full" placeholder="Name" readonly
                                        value="{{ auth()->user()->name }}" </div {{-- value="{{ $draft->preparedBy->name ?? '' }}" --}}>


                                    <div class="intro-y col-span-12 lg:col-span-6 mt-5">
                                        <label for="created_at" class="form-label">Prepared Date</label>
                                        <input id="created_at" type="datetime-local" class="form-control w-full"
                                            readonly name="created_at"
                                            value="{{ \Carbon\Carbon::now()->setTimezone('Asia/Bangkok')->format('Y-m-d\TH:i') }}"
                                            {{-- value="{{ $draft && $draft->created_at ? \Carbon\Carbon::parse($draft->created_at)->format('Y-m-d\TH:i') : '' }}" --}}>
