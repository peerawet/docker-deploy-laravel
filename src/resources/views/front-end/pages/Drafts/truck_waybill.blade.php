                            ...
                            <div id="content-to-be-converted"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="font center"><strong>TRUCK WAYBILL No.</strong></td>
                                        <td colspan="2" class="font center" data-name="truck_waybill_no">
                                            <strong></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2" class="font header">Invoice No.</td>
                                        <td colspan="4" style="height: 25px;" data-name="invoice_no"></td>
                                        <td colspan="2" class="font header">Place of Loading</td>
                                        <td colspan="2" style="height: 25px;" data-name="place_of_loading"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="font header">Date of Receipt</td>
                                        <td colspan="4" style="height: 25px;" data-name="date_of_receipt"></td>
                                        <td colspan="2" class="font header">Place of Discharge</td>
                                        <td colspan="2" style="height: 25px;" data-name="place_of_discharge"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="font header">Truck No.</td>
                                        <td colspan="4" style="height: 25px;" data-name="truck_no"></td>
                                        <td colspan="2" class="font header">Final Destination</td>
                                        <td colspan="2" style="height: 25px;" data-name="final_destination"></td>
                                    </tr>
                                    <tr>
                                        <td class="font header" colspan="2"
                                            style="text-align: center; border-right: 1px solid rgb(198, 204, 200); border-bottom: none; text-decoration: underline;">
                                            Marks and No.</td>
                                        <td class="font header" colspan="2"
                                            style="text-align: center; border-right: 1px solid rgb(198, 204, 200); border-bottom: none; text-decoration: underline;">
                                            No. of Packages</td>
                                        ...
                                        <td class="font header" colspan="2"
                                            ...
                                            Gross/Net Weight</td>
                                        <td class="font header" colspan="2"
                                            style="text-align: center; border-right: 1px solid rgb(150, 150, 150); border-bottom: none; text-decoration: underline;">
                                            Measurements</td>
                                    </tr>
