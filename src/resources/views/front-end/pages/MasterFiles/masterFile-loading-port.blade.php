        ...
        <div class="box p-5">
            ...
            <div class="mb-5">
                <div class="grid grid-cols-12 gap-2">
                    <form id="search-form" class="form-inline col-span-4"
                        action="{{ route('masterFiles.index.loading-port') }}" method="GET">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="table table-bordered table-hover">
                    <thead class="table-dark">
                        <tr class="text-center">
                            <th class="whitespace-nowrap">
                                <a
                                    href="{{ route('masterFiles.index.loading-port', [
                                        'sort_field' => 'id',
                    ...
                    <tbody>
                        <!-- Loop through allLoadingPorts and generate table rows -->
            ...
            <!-- Add New Loading Port Modal -->
            <div id="add-port-modal" class="modal" tabindex="-1" aria-labelledby="modal-title" role="dialog"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modal-title">Add New Loading Port</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <!-- Add New Loading Port form -->
                            <form id="add-port-form" method="POST" action="{{ route('add.loading-port') }}">
                                @csrf
            ...
            <!-- END: Add New Loading Port Modal -->


            <!-- Delete Confirmation Modal for Loading Port -->
                        ...
                        <div class="modal-body p-0">
                            ...
                            <div class="px-5 pb-8 text-center">
                                <form id="delete-port-form" method="POST"
                                    action="{{ route('delete.loading-port', ['id' => '__PORT_ID__']) }}">
                                    @csrf
            ...
            <!-- END: Delete Confirmation Modal for Loading Port -->



            <!-- Edit Loading Port Modal -->
            <div id="edit-port-modal" class="modal" tabindex="-1" aria-labelledby="modal-title" role="dialog"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modal-title">Edit Loading Port</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <!-- Edit Loading Port form -->
                            <form id="edit-port-form" method="POST"
                                action="{{ route('edit.loading-port', ['id' => '__PORT_ID__']) }}">
                                @csrf
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            jQuery('.delete-port-btn').on('click', function() {
                ...
                var formAction = "{{ route('delete.loading-port', ['id' => '__PORT_ID__']) }}";
                ...
                $('#port-name-placeholder').text('Do you want to delete Loading Port ' +
                    portName + '?');
            });
            ...
            jQuery('.edit-port-btn').on('click', function() {
                ...
                var formAction = "{{ route('edit.loading-port', ['id' => '__PORT_ID__']) }}";
